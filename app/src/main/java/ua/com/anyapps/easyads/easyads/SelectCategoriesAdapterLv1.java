...
public class SelectCategoriesAdapterLv1 extends BaseAdapter {
    Context context;
    ...
    public SelectCategoriesAdapterLv1(Context context, ArrayList<OlxCategory> objOlxCategories) {
        this.context = context;
        this.objOlxCategories = objOlxCategories;
        lInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        // объявление по умолчанию
        OlxCategory olxOneCat = new OlxCategory();
        olxOneCat.id = "-1";
        olxOneCat.name = context.getResources().getString(R.string.accounts_list_default_ad);
        objOlxCategories.add(0, olxOneCat);
    }
