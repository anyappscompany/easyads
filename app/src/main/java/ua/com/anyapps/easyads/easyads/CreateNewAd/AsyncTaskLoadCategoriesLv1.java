...
public class AsyncTaskLoadCategoriesLv1 extends AsyncTask<String, Void, Void> {
    private static final String TAG = "debapp";

    private LoadCategoriesLv1Completed taskCompleted;
    private String result="";
    private Context ctxt;
    Handler mHandler = new Handler();

    public AsyncTaskLoadCategoriesLv1(LoadCategoriesLv1Completed context, Context _context) {
    ...
    protected void onPostExecute(Void aVoid) {
        taskCompleted.LoadCategoriesLv1Completed(result);
    ...
    protected Void doInBackground(String... strings) {
        Log.d(TAG, "arrsize " + strings.length);
        ...
        try {
            ...
            categories = catsArray;categories = catsArray;
